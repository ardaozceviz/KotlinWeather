 ...
 */
class LocationServices(private val context: Context, private val userInterface: UserInterface) {
    ...
    private var locationListener: LocationListener = object : LocationListener {
        override fun onLocationChanged(location: Location) {
            ...
            if (location != null) {
                ...
                Server(context, userInterface).getWeatherForCurrentLocation(longitude, latitude)
            } else {
                ...
                if (LocalForecastData(context).retrieveLocation() != null) {
                    ...
                    Server(context, userInterface).getWeatherForCurrentLocation(savedLocation?.first.toString(), savedLocation?.second.toString())
                }
            }
